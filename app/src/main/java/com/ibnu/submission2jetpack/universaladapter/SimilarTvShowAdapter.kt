...
class SimilarTvShowAdapter(private val onClickedAction: OnClickedAction) : RecyclerView.Adapter<SimilarTvShowAdapter.TvShowViewHolder>() {
    ...
    class TvShowViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(tvShow: TvShow) {
            with(itemView) {
                tv_title_tv_show.text = tvShow.tvShowName
                ...
                tv_category_tv_show.text = GenreConverter().displayGenre(tvShow.tvShowCategory)
            }
        }
    }
